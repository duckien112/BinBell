...
function(a) {
    ...
    f = {
        ...
        loading: function() {
            ...
            function() {
                ...
                function() {
                    ...
                    function() {
                        _hmt.push(["_trackPageview", "TRACK"])
                    })
        ...
        initEvent: function() {
            ...
            b.btn_boyaa.on(a,
            function() {
                _hmt.push(["_trackPageview", "click_more_game", "MORE"])
            }),
            b.boyaa_logo.on(a,
            function() {
                _hmt.push(["_trackPageview", "click_boyaa_logo", "LOGO"])
            }),
            b.banner.on(a,
            function() {
