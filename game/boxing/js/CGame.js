function CGame(oData){    
    ...
    this._preloadPW = function(){ 
        ...
        for(var i=0;i<s_aBw_Frame[IDLE];i++){
             s_oSpriteLibrary.addSprite("bw_idle_"+i,"./sprites/bw_idle/bw_idle_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_Frame[GUARD];i++){
             s_oSpriteLibrary.addSprite("bw_guard_"+i,"./sprites/bw_guard/bw_guard_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_Frame[JAB];i++){
             s_oSpriteLibrary.addSprite("bw_jab_"+i,"./sprites/bw_jab/bw_jab_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_Frame[HOOK_R];i++){
             s_oSpriteLibrary.addSprite("bw_hook_r_"+i,"./sprites/bw_hook_right/bw_hook_right_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_Frame[HOOK_L];i++){
             s_oSpriteLibrary.addSprite("bw_hook_l_"+i,"./sprites/bw_hook_left/bw_hook_left_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_Frame[UPPERCUT];i++){
             s_oSpriteLibrary.addSprite("bw_uppercut_"+i,"./sprites/bw_uppercut/bw_uppercut_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_Frame[GETPUNCHED];i++){
             s_oSpriteLibrary.addSprite("bw_get_punched_"+i,"./sprites/bw_get_punched/bw_get_punched_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_Frame[KO];i++){
             s_oSpriteLibrary.addSprite("bw_ko_"+i,"./sprites/bw_ko/bw_ko_"+i+".png");
        }
        /////////////////////////////////////
        ...
        for(var i=0;i<s_aBb_En_Frame[IDLE];i++){
             s_oSpriteLibrary.addSprite("bb_en_idle_"+i,"./sprites/bb_en_idle/bb_en_idle_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_En_Frame[GUARD];i++){
             s_oSpriteLibrary.addSprite("bb_en_guard_"+i,"./sprites/bb_en_guard/bb_en_guard_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_En_Frame[JAB];i++){
             s_oSpriteLibrary.addSprite("bb_en_jab_"+i,"./sprites/bb_en_jab/bb_en_jab_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_En_Frame[HOOK_R];i++){
             s_oSpriteLibrary.addSprite("bb_en_hook_r_"+i,"./sprites/bb_en_hook_right/bb_en_hook_right_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_En_Frame[HOOK_L];i++){
             s_oSpriteLibrary.addSprite("bb_en_hook_l_"+i,"./sprites/bb_en_hook_left/bb_en_hook_left_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_En_Frame[UPPERCUT];i++){
             s_oSpriteLibrary.addSprite("bb_en_uppercut_"+i,"./sprites/bb_en_uppercut/bb_en_uppercut_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_En_Frame[GETPUNCHED];i++){
             s_oSpriteLibrary.addSprite("bb_en_get_punched_"+i,"./sprites/bb_en_get_punched/bb_en_get_punched_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_En_Frame[KO];i++){
             s_oSpriteLibrary.addSprite("bb_en_ko_"+i,"./sprites/bb_en_ko/bb_en_ko_"+i+".png");
        }
     ...
     this._preloadPB = function(){ 
        ...
        for(var i=0;i<s_aBb_Frame[IDLE];i++){
             s_oSpriteLibrary.addSprite("bb_idle_"+i,"./sprites/bb_idle/bb_idle_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_Frame[GUARD];i++){
             s_oSpriteLibrary.addSprite("bb_guard_"+i,"./sprites/bb_guard/bb_guard_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_Frame[JAB];i++){
             s_oSpriteLibrary.addSprite("bb_jab_"+i,"./sprites/bb_jab/bb_jab_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_Frame[HOOK_R];i++){
             s_oSpriteLibrary.addSprite("bb_hook_r_"+i,"./sprites/bb_hook_right/bb_hook_right_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_Frame[HOOK_L];i++){
             s_oSpriteLibrary.addSprite("bb_hook_l_"+i,"./sprites/bb_hook_left/bb_hook_left_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_Frame[UPPERCUT];i++){
             s_oSpriteLibrary.addSprite("bb_uppercut_"+i,"./sprites/bb_uppercut/bb_uppercut_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_Frame[GETPUNCHED];i++){
             s_oSpriteLibrary.addSprite("bb_get_punched_"+i,"./sprites/bb_get_punched/bb_get_punched_"+i+".png");
        }
        
        for(var i=0;i<s_aBb_Frame[KO];i++){
             s_oSpriteLibrary.addSprite("bb_ko_"+i,"./sprites/bb_ko/bb_ko_"+i+".png");
        }
        /////////////////////////////////////
        ...
        for(var i=0;i<s_aBw_En_Frame[IDLE];i++){
             s_oSpriteLibrary.addSprite("bw_en_idle_"+i,"./sprites/bw_en_idle/bw_en_idle_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_En_Frame[GUARD];i++){
             s_oSpriteLibrary.addSprite("bw_en_guard_"+i,"./sprites/bw_en_guard/bw_en_guard_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_En_Frame[JAB];i++){
             s_oSpriteLibrary.addSprite("bw_en_jab_"+i,"./sprites/bw_en_jab/bw_en_jab_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_En_Frame[HOOK_R];i++){
             s_oSpriteLibrary.addSprite("bw_en_hook_r_"+i,"./sprites/bw_en_hook_right/bw_en_hook_right_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_En_Frame[HOOK_L];i++){
             s_oSpriteLibrary.addSprite("bw_en_hook_l_"+i,"./sprites/bw_en_hook_left/bw_en_hook_left_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_En_Frame[UPPERCUT];i++){
             s_oSpriteLibrary.addSprite("bw_en_uppercut_"+i,"./sprites/bw_en_uppercut/bw_en_uppercut_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_En_Frame[GETPUNCHED];i++){
             s_oSpriteLibrary.addSprite("bw_en_get_punched_"+i,"./sprites/bw_en_get_punched/bw_en_get_punched_"+i+".png");
        }
        
        for(var i=0;i<s_aBw_En_Frame[KO];i++){
             s_oSpriteLibrary.addSprite("bw_en_ko_"+i,"./sprites/bw_en_ko/bw_en_ko_"+i+".png");
        }
    ...
    this.regenStamina =function(){
         _iPSt= _iPSt+ STAMINA_REGEN_SPEED;
         if(_iPSt > PLAYER_STAMINA){
             _iPSt = PLAYER_STAMINA;
         }
         s_oInterface.setPlayerStamina(_iPSt);
    ...
    this.closeHelpPanel=function(){  
        ...
        _oCrowdIdle=playSound("crowd_idle", 1,-1);
        playSound("start_match", 1,0);
    ...
    this.update = function(){
        ...
        if(_bUpdate && !_bHelpPanelOpen){
           ...
           if(_iTimeElaps>STAMINA_REGEN_TIME){  
             if((!bPlayerIsPunching && _iPSt <PLAYER_STAMINA) && !_bIsRegStamina ){  
                _iTimeElaps=0;
                _bIsRegStamina=true;
                this.regenStamina();
             }
    ...
    STAMINA_REGEN_SPEED = oData.player_stamina_regen_speed;
    STAMINA_PUNCH_LIMIT = oData.stamina_punch_limit;
    
    s_aDamage[JAB]=oData.jab_damage;
    s_aDamage[HOOK_R]=oData.hook_left_damage;
    s_aDamage[HOOK_L]=oData.hook_right_damage;
    s_aDamage[UPPERCUT]=oData.uppercut_damage;
